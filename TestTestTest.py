#Just a local test file DO NOT COMMIT
...
class nchain2:
    ...
    def DO(self,action):
        ...
        return np.array([0,0,self.cash,self.stock]) , self.reward2, self.done
    ...
    def reset(self):
        ...
        self.cash = 5
        self.stock = 0
        return np.array([0,0,self.cash,self.stock])
...
model = q_learning_keras(env,500)
